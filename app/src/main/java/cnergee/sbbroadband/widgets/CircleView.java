...
public class CircleView extends View {
    ...
    private static int DEFAULT_TITLE_COLOR = Color.LTGRAY;
    ...
    private static int DEFAULT_STROKE_COLOR = Color.LTGRAY;
    ...
    private void init(AttributeSet attrs, int defStyle) {
       ...
       /* Typeface myTypeface = Typeface.createFromAsset(getContext().getAssets(), "fonts/rockwell.ttf");
        setTypeface(myTypeface);*/
        mTitleTextPaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/rockwell.ttf"));
        ...
        mSubTextPaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/rockwell.ttf"));
